#!/usr/bin/env python3
"""
Fix for quiz_feedback_api.py to handle JSON string validation_passes
"""
...
with open('quiz_feedback_api_fixed.py', 'w') as f:
    f.write(fix_content)

print("Fixed quiz_feedback_api.py created as quiz_feedback_api_fixed.py")